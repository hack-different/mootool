...
DEVICE_TREE_D49AP = fixture_file('DeviceTree.d49ap.dtre')
DEVICE_TREE_IM4P_D49AP = fixture_file('DeviceTree.d49ap.im4p')
DEVICE_TREE_J274AP = fixture_file('DeviceTree.j274ap.dtre')
...
describe MooTool::Models::DeviceTree do
  it 'is able to parse a device tree' do
    device_tree = described_class.load(DEVICE_TREE_D49AP)
