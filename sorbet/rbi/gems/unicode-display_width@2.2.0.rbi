...
class Unicode::DisplayWidth
  ...
  def initialize(ambiguous: T.unsafe(nil), overwrite: T.unsafe(nil), emoji: T.unsafe(nil))
    ;
  end
  ...
  class << self
    ...
    def emoji_extra_width_of(string, ambiguous = T.unsafe(nil), overwrite = T.unsafe(nil), _ = T.unsafe(nil))
      ;
    end

    # source://unicode-display_width-2.2.0/lib/unicode/display_width.rb:10
    def of(string, ambiguous = T.unsafe(nil), overwrite = T.unsafe(nil), options = T.unsafe(nil))
      ;
    end
  end
end
