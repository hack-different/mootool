...
class Parser::Base < ::Racc::Parser
  ...
  def tokenize(source_buffer, recover = T.unsafe(nil))
    ;
  end
  ...
  def diagnostic(level, reason, arguments, location_t, highlights_ts = T.unsafe(nil))
    ;
  end
  ...
  class << self
    ...
    def parse(string, file = T.unsafe(nil), line = T.unsafe(nil))
      ;
    end
    ...
    def parse_with_comments(string, file = T.unsafe(nil), line = T.unsafe(nil))
      ;
    end
    ...
    def setup_source_buffer(file, line, string, encoding)
      ;
    end
  end
end
...
class Parser::Builders::Default
  ...
  def args(begin_t, args, end_t, check_args = T.unsafe(nil))
    ;
  end
  ...
  def begin_body(compound_stmt, rescue_bodies = T.unsafe(nil), else_t = T.unsafe(nil), else_ = T.unsafe(nil), ensure_t = T.unsafe(nil), ensure_ = T.unsafe(nil))
    ;
  end
  ...
  def call_method(receiver, dot_t, selector_t, lparen_t = T.unsafe(nil), args = T.unsafe(nil), rparen_t = T.unsafe(nil))
    ;
  end
  ...
  def def_endless_method(def_t, name_t, args, assignment_t, body)
    ;
  end

  # source://parser-3.1.2.1/lib/parser/builders/default.rb:856
  def def_endless_singleton(def_t, definee, dot_t, name_t, args, assignment_t, body)
    ;
  end
  ...
  # source://parser-3.1.2.1/lib/parser/builders/default.rb:237
  def emit_file_line_as_literals=(_arg0)
    ;
  end
  ...
  def keyword_cmd(type, keyword_t, lparen_t = T.unsafe(nil), args = T.unsafe(nil), rparen_t = T.unsafe(nil))
    ;
  end
  ...
  def kwrestarg(dstar_t, name_t = T.unsafe(nil))
    ;
  end
  ...
  def match_rest(star_t, name_t = T.unsafe(nil))
    ;
  end
  ...
  def not_op(not_t, begin_t = T.unsafe(nil), receiver = T.unsafe(nil), end_t = T.unsafe(nil))
    ;
  end
  ...
  def objc_restarg(star_t, name = T.unsafe(nil))
    ;
  end
  ...
  def restarg(star_t, name_t = T.unsafe(nil))
    ;
  end

  # source://parser-3.1.2.1/lib/parser/builders/default.rb:1009
  def restarg_expr(star_t, expr = T.unsafe(nil))
    ;
  end
  ...
  def splat(star_t, arg = T.unsafe(nil))
    ;
  end
  ...
  def arg_prefix_map(op_t, name_t = T.unsafe(nil))
    ;
  end
  ...
  def check_duplicate_arg(this_arg, map = T.unsafe(nil))
    ;
  end

  # source://parser-3.1.2.1/lib/parser/builders/default.rb:1717
  def check_duplicate_args(args, map = T.unsafe(nil))
    ;
  end
  ...
  def diagnostic(type, reason, arguments, location, highlights = T.unsafe(nil))
    ;
  end

  # source://parser-3.1.2.1/lib/parser/builders/default.rb:2165
  def eh_keyword_map(compstmt_e, keyword_t, body_es, else_t, else_e)
    ;
  end
  ...
  def kwarg_map(name_t, value_e = T.unsafe(nil))
    ;
  end
  ...
  def rescue_body_map(keyword_t, exc_list_e, assoc_t, exc_var_e, then_t, compstmt_e)
    ;
  end
  ...
  def send_map(receiver_e, dot_t, selector_t, begin_t = T.unsafe(nil), args = T.unsafe(nil), end_t = T.unsafe(nil))
    ;
  end
  ...
  def unary_op_map(op_t, arg_e = T.unsafe(nil))
    ;
  end
  ...
  class << self
    ...
    # source://parser-3.1.2.1/lib/parser/builders/default.rb:97
    def emit_arg_inside_procarg0=(_arg0)
      ;
    end
...
module Parser::Deprecation
  ...
  def warned_of_deprecation=(_arg0)
    ;
  end
end
...
class Parser::Diagnostic
  ...
  def initialize(level, reason, arguments, location, highlights = T.unsafe(nil))
    ;
  end
  ...
  def render_line(range, ellipsis = T.unsafe(nil), range_end = T.unsafe(nil))
    ;
  end
end
...
class Parser::Diagnostic::Engine
  ...
  def initialize(consumer = T.unsafe(nil))
    ;
  end
  ...
  # source://parser-3.1.2.1/lib/parser/diagnostic/engine.rb:39
  def all_errors_are_fatal=(_arg0)
    ;
  end
...
class Parser::Lexer
  ...
  def reset(reset_state = T.unsafe(nil))
    ;
  end
  ...
  def diagnostic(type, reason, arguments = T.unsafe(nil), location = T.unsafe(nil), highlights = T.unsafe(nil))
    ;
  end

  # source://parser-3.1.2.1/lib/parser/lexer.rb:24857
  def emit(type, value = T.unsafe(nil), s = T.unsafe(nil), e = T.unsafe(nil))
    ;
  end

  # source://parser-3.1.2.1/lib/parser/lexer.rb:24891
  def emit_comment(s = T.unsafe(nil), e = T.unsafe(nil))
    ;
  end

  # source://parser-3.1.2.1/lib/parser/lexer.rb:24873
  def emit_do(do_block = T.unsafe(nil))
    ;
  end

  # source://parser-3.1.2.1/lib/parser/lexer.rb:24867
  def emit_table(table, s = T.unsafe(nil), e = T.unsafe(nil))
    ;
  end
  ...
  def range(s = T.unsafe(nil), e = T.unsafe(nil))
    ;
  end
  ...
  def tok(s = T.unsafe(nil), e = T.unsafe(nil))
    ;
  end
  ...
  class << self
    ...
    #
    # source://parser-3.1.2.1/lib/parser/lexer.rb:11100
    def lex_en_expr_labelarg=(_arg0)
      ;
    end
    ...
    #
    # source://parser-3.1.2.1/lib/parser/lexer.rb:11064
    def lex_en_expr_variable=(_arg0)
      ;
    end
    ...
    #
    # source://parser-3.1.2.1/lib/parser/lexer.rb:11044
    def lex_en_interp_backslash_delimited=(_arg0)
      ;
    end
    ...
    #
    # source://parser-3.1.2.1/lib/parser/lexer.rb:11052
    def lex_en_interp_backslash_delimited_words=(_arg0)
      ;
    end
    ...
    #
    # source://parser-3.1.2.1/lib/parser/lexer.rb:11032
    def lex_en_interp_string=(_arg0)
      ;
    end
    ...
    #
    # source://parser-3.1.2.1/lib/parser/lexer.rb:11048
    def lex_en_plain_backslash_delimited=(_arg0)
      ;
    end
    ...
    #
    # source://parser-3.1.2.1/lib/parser/lexer.rb:11056
    def lex_en_plain_backslash_delimited_words=(_arg0)
      ;
    end
    ...
    #
    # source://parser-3.1.2.1/lib/parser/lexer.rb:11060
    def lex_en_regexp_modifiers=(_arg0)
      ;
    end
    ...
    #
    # source://parser-3.1.2.1/lib/parser/lexer.rb:10753
    def _lex_from_state_actions=(_arg0)
      ;
    end
    ...
    #
    # source://parser-3.1.2.1/lib/parser/lexer.rb:10620
    def _lex_to_state_actions=(_arg0)
      ;
    end
...
class Parser::Lexer::Literal
  ...
  def initialize(lexer, str_type, delimiter, str_s, heredoc_e = T.unsafe(nil), indent = T.unsafe(nil), dedent_body = T.unsafe(nil), label_allowed = T.unsafe(nil))
    ;
  end
  ...
  def nest_and_try_closing(delimiter, ts, te, lookahead = T.unsafe(nil))
    ;
  end
...
class Parser::Source::Buffer
  ...
  def initialize(name, first_line = T.unsafe(nil), source: T.unsafe(nil))
    ;
  end
...
class Parser::Source::Comment
  ...
  class << self
    ...
    def associate_by_identity(ast, comments)
      ;
    end
    ...
    def associate_locations(ast, comments)
      ;
    end
  end
end
...
class Parser::Source::Map::Variable < ::Parser::Source::Map
  ...
  def initialize(name_l, expression_l = T.unsafe(nil))
    ;
  end
...
class Parser::Source::Range
  ...
  def adjust(begin_pos: T.unsafe(nil), end_pos: T.unsafe(nil))
    ;
  end
  ...
  def with(begin_pos: T.unsafe(nil), end_pos: T.unsafe(nil))
    ;
  end
end
...
class Parser::Source::Rewriter::Action
  ...
  def initialize(range, replacement = T.unsafe(nil), allow_multiple_insertions = T.unsafe(nil), order = T.unsafe(nil))
    ;
  end
...
class Parser::Source::TreeRewriter
  ...
  def initialize(source_buffer, crossing_deletions: T.unsafe(nil), different_replacements: T.unsafe(nil), swallowed_insertions: T.unsafe(nil))
    ;
  end
  ...
  def import!(foreign_rewriter, offset: T.unsafe(nil))
    ;
  end
  ...
  def trigger_policy(event, range: T.unsafe(nil), conflict: T.unsafe(nil), **arguments)
    ;
  end
end
...
class Parser::Source::TreeRewriter::Action
  ...
  def initialize(range, enforcer, insert_before: T.unsafe(nil), replacement: T.unsafe(nil), insert_after: T.unsafe(nil), children: T.unsafe(nil))
    ;
  end
  ...
  def bsearch_child_index(from = T.unsafe(nil))
    ;
  end
  ...
  def with(range: T.unsafe(nil), enforcer: T.unsafe(nil), children: T.unsafe(nil), insert_before: T.unsafe(nil), replacement: T.unsafe(nil), insert_after: T.unsafe(nil))
    ;
  end
end
...
class Parser::TreeRewriter < ::Parser::AST::Processor
  ...
  def rewrite(source_buffer, ast, **policy)
    ;
  end
