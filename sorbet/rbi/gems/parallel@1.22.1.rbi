...
module Parallel
  ...
  class << self
    ...
    def each(array, options = T.unsafe(nil), &block)
      ;
    end

    # source://parallel-1.22.1/lib/parallel.rb:251
    def each_with_index(array, options = T.unsafe(nil), &block)
      ;
    end
    ...
    def in_processes(options = T.unsafe(nil), &block)
      ;
    end

    # source://parallel-1.22.1/lib/parallel.rb:215
    def in_threads(options = T.unsafe(nil))
      ;
    end

    # source://parallel-1.22.1/lib/parallel.rb:255
    def map(source, options = T.unsafe(nil), &block)
      ;
    end

    # source://parallel-1.22.1/lib/parallel.rb:302
    def map_with_index(array, options = T.unsafe(nil), &block)
      ;
    end
...
class Parallel::Break < ::StandardError
  ...
  def initialize(value = T.unsafe(nil))
    ;
  end
