...
module T::Generic
  ...
  def type_member(variance = T.unsafe(nil), fixed: T.unsafe(nil), lower: T.unsafe(nil), upper: T.unsafe(nil), &bounds_proc)
    ;
  end

  # source://tapioca-0.9.2/lib/tapioca/sorbet_ext/generic_name_patch.rb:37
  def type_template(variance = T.unsafe(nil), fixed: T.unsafe(nil), lower: T.unsafe(nil), upper: T.unsafe(nil), &bounds_proc)
    ;
  end
end
...
class T::Private::Methods::Declaration < ::Struct
  ...
  def override_allow_incompatible=(_)
    ;
  end
...
class T::Private::Methods::Signature
  ...
  def initialize(method:, method_name:, raw_arg_types:, raw_return_type:, bind:, mode:, check_level:, on_failure:, parameters: T.unsafe(nil), override_allow_incompatible: T.unsafe(nil), defined_raw: T.unsafe(nil))
    ;
  end
  ...
  class << self
    ...
    def new_untyped(method:, mode: T.unsafe(nil), parameters: T.unsafe(nil))
      ;
    end
  end
end
...
module T::Types::ProcBindPatch
  ...
  def initialize(arg_types, returns, bind = T.unsafe(nil))
    ;
  end
...
module Tapioca::CliHelper
  ...
  def say_error(message = T.unsafe(nil), *color)
    ;
  end
end
...
class Tapioca::Commands::Annotations < ::Tapioca::Commands::Command
  ...
  def initialize(central_repo_root_uris:, auth: T.unsafe(nil), netrc_file: T.unsafe(nil), central_repo_index_path: T.unsafe(nil), typed_overrides: T.unsafe(nil))
    ;
  end
...
class Tapioca::Commands::CheckShims < ::Tapioca::Commands::Command
  ...
  def initialize(gem_rbi_dir:, dsl_rbi_dir:, annotations_rbi_dir:, shim_rbi_dir:, todo_rbi_file:, payload:, number_of_workers:)
    ;
  end
...
class Tapioca::Commands::Command
  ...
  def create_file(path, content, force: T.unsafe(nil), skip: T.unsafe(nil), verbose: T.unsafe(nil))
    ;
  end
  ...
  def remove_file(path, verbose: T.unsafe(nil))
    ;
  end
end
...
class Tapioca::Commands::Configure < ::Tapioca::Commands::Command
  ...
  def initialize(sorbet_config:, tapioca_config:, default_postrequire:)
    ;
  end
...
class Tapioca::Commands::Dsl < ::Tapioca::Commands::Command
  ...
  def initialize(requested_constants:, outpath:, only:, exclude:, file_header:, compiler_path:, tapioca_path:, should_verify: T.unsafe(nil), quiet: T.unsafe(nil), verbose: T.unsafe(nil), number_of_workers: T.unsafe(nil), auto_strictness: T.unsafe(nil), gem_dir: T.unsafe(nil), rbi_formatter: T.unsafe(nil))
    ;
  end
  ...
  def compile_dsl_rbi(constant_name, rbi, outpath: T.unsafe(nil), quiet: T.unsafe(nil))
    ;
  end
  ...
  def existing_rbi_filenames(requested_constants, path: T.unsafe(nil))
    ;
  end
...
class Tapioca::Commands::Gem < ::Tapioca::Commands::Command
  ...
  def initialize(gem_names:, exclude:, prerequire:, postrequire:, typed_overrides:, outpath:, file_header:, include_doc:, include_loc:, include_exported_rbis:, number_of_workers: T.unsafe(nil), auto_strictness: T.unsafe(nil), dsl_dir: T.unsafe(nil), rbi_formatter: T.unsafe(nil))
    ;
  end
  ...
  def sync(should_verify: T.unsafe(nil), exclude: T.unsafe(nil))
    ;
  end
  ...
  def perform_sync_verification(exclude: T.unsafe(nil))
    ;
  end
...
class Tapioca::Dsl::Compiler
  ...
  def create_method_from_def(scope, method_def, class_method: T.unsafe(nil))
    ;
  end
...
class Tapioca::Dsl::Pipeline
  ...
  def initialize(requested_constants:, requested_compilers: T.unsafe(nil), excluded_compilers: T.unsafe(nil), error_handler: T.unsafe(nil), number_of_workers: T.unsafe(nil))
    ;
  end
...
class Tapioca::Executor
  ...
  def initialize(queue, number_of_workers: T.unsafe(nil))
    ;
  end
...
class Tapioca::Gem::Listeners::Methods < ::Tapioca::Gem::Listeners::Base
  ...
  def compile_directly_owned_methods(tree, module_name, mod, for_visibility = T.unsafe(nil))
    ;
  end
  ...
  def compile_method(tree, symbol_name, constant, method, visibility = T.unsafe(nil))
    ;
  end
...
class Tapioca::Gem::Listeners::YardDoc < ::Tapioca::Gem::Listeners::Base
  ...
  def documentation_comments(name, sigs: T.unsafe(nil))
    ;
  end
...
class Tapioca::Gem::Pipeline
  ...
  def initialize(gem, include_doc: T.unsafe(nil), include_loc: T.unsafe(nil))
    ;
  end
  ...
  def compile_module(name, constant, foreign_constant: T.unsafe(nil))
    ;
  end
  ...
  def defined_in_gem?(constant, strict: T.unsafe(nil))
    ;
  end
...
module Tapioca::RBIFilesHelper
  ...
  def validate_rbi_files(command:, gem_dir:, dsl_dir:, auto_strictness:, gems: T.unsafe(nil), compilers: T.unsafe(nil))
    ;
  end
...
class Tapioca::RBIFormatter < ::RBI::Formatter
  ...
  def write_header!(file, command, reason: T.unsafe(nil))
    ;
  end
end
...
class Tapioca::Runtime::Loader
  ...
  def load_rails_application(environment_load: T.unsafe(nil), eager_load: T.unsafe(nil))
    ;
  end
...
module Tapioca::Runtime::Reflection
  ...
  def constantize(symbol, inherit: T.unsafe(nil), namespace: T.unsafe(nil))
    ;
  end
...
module Tapioca::SorbetHelper
  ...
  def sorbet_supports?(feature, version: T.unsafe(nil))
    ;
  end
end
...
module Tapioca::Static::SymbolLoader
  ...
  class << self
    ...
    def engines(*args, **_arg1, &blk)
      ;
    end

    # source://tapioca-0.9.2/lib/tapioca/static/symbol_loader.rb:59
    sig { params(input: ::String, table_type: ::String).returns(::String) }
    def symbol_table_json_from(input, table_type: T.unsafe(nil))
      ;
    end
